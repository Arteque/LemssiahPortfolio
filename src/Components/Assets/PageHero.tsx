...
const PageHero:FC<pageHeroProps> = ({pageTitle, pageDescription, bgImg}) => {
  return (
    <section className="bg-bg-200" style={{backgroundImage:`url(${bgImg})`, backgroundRepeat:'no-repeat', backgroundSize:'cover', backgroundPosition:'center', backgroundBlendMode:"overlay"}}>
        <Container>
